...
namespace MissionPlanner
{
    public class MAVState : MAVLink, IDisposable
    {
        ...
        // 内部编队偏移
        public Vector3 internaloffset = new Vector3();

        public struct SawmAdvancedParameters
        {
            public float targettrailerscale;
            public int targetleaderdis_m;
            public int yawdistanceboundary_m;
            public int rolllowdistboundary_m;
            public int rollhighdistboundary_m;
            public int rollmindisttotarget_m;
            public int yawtorollmaxangle_deg;
            public int maxdisttodspd_m;
            public int distintegseparation_m;
            public float deltaspeedscale;
            public float thrusttrim;
            public float thrustmin;
            public int mintargetspeed;
            public int predistancetolosespeed;
            public bool stallprotect;
        }
        public SawmAdvancedParameters sawmAdvancedParameters = new SawmAdvancedParameters();
        public struct TargetTrackingInfo
        {
            public bool newfind;
            public List<PointLatLngAlt> targets;
            public int maxrecord;
            public DateTime timestamp;
        }
        public TargetTrackingInfo targetTrackingInfo = new TargetTrackingInfo() {
            targets = new List<PointLatLngAlt>(),
            newfind = false, maxrecord = 200,
        };
        // 编队控制数据
        //纵向
        public double SwarmTargetAlt = 0;
        public double SwarmNavPitch = 0;
        public double SwarmDistToTarg = 0;
        public double SwarmNavSpeed = 0;
        public double SwarmNavThurst = 0;
        //横侧向
        public double SwarmNavRoll = 0;
        public double SwarmTargYaw = 0;
        public double SwarmNavBearing = 0;
        public double SwarmYawError = 0;
        // 与长机的间距
        public double SwarmDistToLeader = 0;
        // 目标点的航迹推算
        public double CourseOfTarget = 0;
        // 目标点的速度计算
        public float SpeedOfTarget = 0;
        ...
        // 避障算法运行完得到的向量
        public Vector3 obsvector = new Vector3();
        // 障碍物id
