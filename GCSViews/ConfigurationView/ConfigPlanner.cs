...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigPlanner : UserControl, IActivate
    {
        ...
        static temp temp;
        public static ConfigPlanner ConfigPlannerInstance = null;
        ...
        static public int videosources1index = 0;
        private void BUT_videostart_Click(object sender, EventArgs e)
        {
            ...
            videosources1index = CMB_videosources.SelectedIndex;
            if (FormationControl.instance != null)
            {
                if (FormationControl.instance.CMB_video1sources.SelectedItem != null && videosources1index == FormationControl.instance.CMB_video1sources.SelectedIndex)
                {
                    if (FormationControl.instance.cam1 != null)
                    {
                        CustomMessageBox.Show("目标设备已经打开请先关闭");
                        return;
                        //FormationControl.instance.BUT_video1stop_Click(sender, e);
                        //System.Threading.Thread.Sleep(500);
                    }
                }
                if (FormationControl.instance.CMB_video2sources.SelectedItem != null && videosources1index == FormationControl.instance.CMB_video2sources.SelectedIndex)
                {
                    if (FormationControl.instance.cam2 != null)
                    {
                        CustomMessageBox.Show("目标设备已经打开请先关闭");
                        return;
                        //FormationControl.instance.BUT_video2stop_Click(sender, e);
                        //System.Threading.Thread.Sleep(500);
                    }
                }
            }
