...
namespace MissionPlanner.HIL
{
    ...
    public abstract class Hil
    {
        ...
        public const float gravity_mss = (float)9.80665f;
        ...
        public sitl_fdm sitl_data = new sitl_fdm();
        ...
        public void setRevPitch(int value)
        {
            REV_pitch = Constrain(value,-1,1);
        }
        public void setRevRoll(int value)
        {
            REV_roll = Constrain(value, -1, 1);
        }
        public void setRevYaw(int value)
        {
            REV_rudder = Constrain(value, -1, 1);
        }
        ...
        public abstract void GetFromSim();
        public abstract void SendToSim();
        public abstract void SendToAP(MAVLinkInterface port, MAVState mav);
        ...
        internal int Constrain(int value, int min, int max)
        {
            if (value > max)
            {
                value = max;
